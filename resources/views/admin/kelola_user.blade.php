...
<body>
    ...
    <div id="page-container"
      ...
      -->
                    ...
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link active" href="bd_kelolauser.html">
        ...
        <main id="main-container">
            ...
            <div class="content">
                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-header block-header-default">
                        ...
                        <h3 class="block-title">Kelola User</h3>
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="fw-semibold fs-sm">John Doe</td>
                                    <td class="d-none d-sm-table-cell fs-sm">
                                        Admin
                                    </td>
                                    <td class="d-none d-sm-table-cell">
                                        <span
                                            class="fs-xs fw-semibold d-inline-block py-1 px-3 rounded-pill bg-success-light text-success">Aktif</span>
                                    </td>
                                    <td class="d-none d-sm-table-cell">
                                        <button type="button" class="btn btn-sm btn-warning me-1 mb-1"  onclick="openModalUbahRole('1', 'Admin')">
                                            <i class="fa fa-fw fa-pencil-alt me-1"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger" onclick="confirmDeactivate('1')">
                                ...
                                <tr>
                                    ...
                                    <td class="fw-semibold fs-sm">Jane Smith</td>
                                    <td class="d-none d-sm-table-cell fs-sm">
                                        Reviewer
                                    </td>
                                    <td class="d-none d-sm-table-cell">
                                    ...
                                    <td class="d-none d-sm-table-cell">
                                        <button type="button" class="btn btn-sm btn-warning me-1 mb-1"  onclick="openModalUbahRole('2', 'Reviewer')">
                                            <i class="fa fa-fw fa-pencil-alt me-1"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger" onclick="confirmDeactivate('2')">
                                            <i class="fa fa-fw fa-times me-1"></i>
                                        </button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="fw-semibold fs-sm">Alex Johnson</td>
                                    <td class="d-none d-sm-table-cell fs-sm">
                                        Author
                                    </td>
                                    <td class="d-none d-sm-table-cell">
                                        <span
                                            class="fs-xs fw-semibold d-inline-block py-1 px-3 rounded-pill bg-danger-light text-danger">Tidak
                                            Aktif</span>
                                    </td>
                                    <td class="d-none d-sm-table-cell">
                                        <button type="button" class="btn btn-sm btn-warning me-1 mb-1"  onclick="openModalUbahRole('3', 'Author')">
                                            <i class="fa fa-fw fa-pencil-alt me-1"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger" onclick="confirmDeactivate('3')">
                                            <i class="fa fa-fw fa-times me-1"></i>
                                        </button>
                                    </td>
                                </tr>
            ...
            <!-- END Page Content -->
            <div class="modal fade" id="modalUbahRole" tabindex="-1" role="dialog" aria-labelledby="modalUbahRoleLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalUbahRoleLabel">Ubah Role</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form id="formUbahRole">
                                <div class="mb-3">
                                    <label for="roleSelectModal" class="form-label">Pilih Role Baru</label>
                                    <select class="form-select" id="roleSelectModal">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="confirmChangeRole()">Simpan
                                Perubahan</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="content py-3">
                <div class="row fs-sm">
                    ...
                    <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
                        <a class="fw-semibold" href="https://pixelcave.com/products/oneui" target="_blank">PENGHOBBY.ID</a>
    ...
    <script>
        // Function untuk membuka modal dan mengisi data user
        function openModalUbahRole(userId, currentRole) {
            document.getElementById('userIdModal').value = userId;
            document.getElementById('roleSelectModal').value = currentRole;
            var modal = new bootstrap.Modal(document.getElementById('modalUbahRole'));
            modal.show();
        }

        // Function untuk mengkonfirmasi perubahan role
        function confirmChangeRole() {
            let userId = document.getElementById('userIdModal').value;
            let selectedRole = document.getElementById('roleSelectModal').value;

            Swal.fire({
                title: 'Apakah Anda yakin?',
                text: "Role akan diubah menjadi " + selectedRole + ".",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    // Lakukan aksi untuk mengubah role, seperti panggilan AJAX atau form submit
                    Swal.fire(
                        'Berhasil!',
                    ...
                    var modal = bootstrap.Modal.getInstance(document.getElementById('modalUbahRole'));
                    modal.hide();
                }
            });
        }

        // Function untuk konfirmasi nonaktifkan user
        function confirmDeactivate(userId) {
            Swal.fire({
                title: 'Apakah Anda yakin?',
                text: "User ini akan dinonaktifkan.",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    // Lakukan aksi untuk menonaktifkan user, seperti panggilan AJAX
                    Swal.fire(
                        'Berhasil!',
