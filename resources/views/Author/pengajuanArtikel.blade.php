                ...
                <div class="block block-rounded overflow-hidden">
                    ...
                    <div class="block-content tab-content overflow-hidden">
                        ...
                        <div class="tab-pane fade fade-up show active" id="search-projects" role="tabpanel"
                            aria-labelledby="search-projects-tab" tabindex="0">
                            <div class="fs-4 fw-semibold p-2 mb-4 bg-body-light">
                                <a href="bd_createpengajuanjurnal.html" class="btn btn-primary">Buat Artikel</a>
                            </div>
                            <table class="table table-striped table-vcenter">
                                <thead>
                                    <tr>
                                        <th style="width: 50%;">Artikel</th>
                                        <th class="d-none d-lg-table-cell text-center" style="width: 15%;">Kategori</th>
                                        <th class="d-none d-lg-table-cell text-center" style="width: 15%;">Komunitas
                                        </th>
                                    ...
                                    <tr>
                                        <td>
                                            <h4 class="h5 mt-3 mb-2">
                                                <a href="bd_dashboard.html">Web Application Framework</a>
                                            </h4>
                                            <p class="d-none d-sm-block text-muted">
                                                Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit
                                                nibh, ac cursus nibh sapien in purus. Mauris tincidunt tincidunt turpis
                                                in porta.
                                            </p>
                                        </td>

                                        <td class="d-none d-lg-table-cell text-center text-sm">Teknologi
                                        </td>
                                        <td class="font-size-xl text-center fw-semibold">Technology Comunity</td>
                                        <td class="d-none d-lg-table-cell text-center text-sm font-size-xl text-center fw-semibold">
                                            <span
                                                class="fw-semibold d-inline-block py-1 px-3 rounded-pill bg-success-light text-dark fs-sm">Submitted</span>
                                        </td>
                                    </tr>
