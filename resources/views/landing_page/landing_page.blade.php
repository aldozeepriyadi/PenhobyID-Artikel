                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-xl-10 col-lg-10 col-md-12 header-flex">
                                ...
                                <!-- Main-menu --><button id="scroll-left" class="scroll-btn"><i
                                        class="fas fa-chevron-left"></i></button>x
                                <div class="main-menu d-none d-md-block">

                                    <nav>

                                        <ul id="navigation" class="horizontal-scroll-container">
                                            <li><a href="index.html">Home</a></li>
                                            <li><a href="elements.html">Petualangan</a></li>
                                            <li><a href="blog.html">Teknologi</a></li>
                                            <li><a href="single-blog.html">Seni</a></li>
                                            <li><a href="details.html">Budaya</a></li>
                                            <li><a href="elements.html">Teknologi Comunity</a></li>
                                            <li><a href="blog.html">Jabar Seni Community</a></li>
                                            <li><a href="single-blog.html">Budaya Jawa Barat</a></li>
                                            <li><a href="details.html">Pencinta Alam Bandung</a></li>
                                ...
                                <button id="scroll-right" class="scroll-btn"><i
